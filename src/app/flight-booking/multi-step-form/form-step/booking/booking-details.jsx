...
const TabButton = (props) => {
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        "flex px-6 py-3 items-center justify-center rounded text-sm font-medium cursor-pointer bg-[#F1F1F4]",
        {
    ...
    >
      <p
        className={`px-2 flex items-start justify-center rounded-[2px] mr-4 text-white ${
